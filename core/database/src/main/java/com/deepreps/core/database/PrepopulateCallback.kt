...
internal class PrepopulateCallback : RoomDatabase.Callback() {
    ...
    private fun insertLegsExercises(db: SupportSQLiteDatabase) {
        insertExercise(db, 1, "legs_barbell_back_squat", "Barbell Back Squat",
        ...
        insertExercise(db, 2, "legs_barbell_front_squat", "Barbell Front Squat",
        ...
        insertExercise(db, 3, "legs_machine_leg_press", "Leg Press",
        ...
        insertExercise(db, 4, "legs_barbell_rdl", "Romanian Deadlift (RDL)",
        ...
        insertExercise(db, 5, "legs_dumbbell_walking_lunge", "Walking Lunges",
        ...
        insertExercise(db, 6, "legs_dumbbell_bulgarian_split_squat", "Bulgarian Split Squat",
        ...
        insertExercise(db, 7, "legs_machine_hack_squat", "Hack Squat",
        ...
        insertExercise(db, 8, "legs_machine_leg_extension", "Leg Extension",
        ...
        insertExercise(db, 9, "legs_machine_lying_leg_curl", "Lying Leg Curl",
        ...
        insertExercise(db, 10, "legs_machine_seated_leg_curl", "Seated Leg Curl",
        ...
        insertExercise(db, 11, "legs_machine_standing_calf_raise", "Standing Calf Raise",
        ...
        insertExercise(db, 12, "legs_machine_seated_calf_raise", "Seated Calf Raise",
    ...
    private fun insertLowerBackExercises(db: SupportSQLiteDatabase) {
        insertExercise(db, 13, "lower_back_barbell_conventional_deadlift", "Conventional Deadlift",
        ...
        insertExercise(db, 14, "lower_back_barbell_sumo_deadlift", "Sumo Deadlift",
        ...
        insertExercise(db, 15, "lower_back_trapbar_deadlift", "Trap Bar Deadlift",
        ...
        insertExercise(db, 16, "lower_back_barbell_rack_pull", "Rack Pull",
        ...
        insertExercise(db, 17, "lower_back_barbell_good_morning", "Good Morning",
        ...
        insertExercise(db, 18, "lower_back_bodyweight_back_extension", "Back Extension (45-degree)",
        ...
        insertExercise(db, 19, "lower_back_machine_reverse_hyperextension", "Reverse Hyperextension",
        ...
        insertExercise(db, 20, "lower_back_barbell_hip_thrust", "Barbell Hip Thrust",
        ...
        insertExercise(db, 21, "lower_back_cable_pull_through", "Cable Pull-Through",
        ...
        insertExercise(db, 22, "lower_back_barbell_deficit_deadlift", "Deficit Deadlift",
    ...
    private fun insertChestExercises(db: SupportSQLiteDatabase) {
        insertExercise(db, 23, "chest_barbell_bench_press", "Barbell Bench Press",
        ...
        insertExercise(db, 24, "chest_barbell_incline_bench_press", "Incline Barbell Bench Press",
        ...
        insertExercise(db, 25, "chest_dumbbell_bench_press", "Dumbbell Bench Press",
        ...
        insertExercise(db, 26, "chest_dumbbell_incline_dumbbell_press", "Incline Dumbbell Press",
        ...
        insertExercise(db, 27, "chest_barbell_decline_bench_press", "Decline Barbell Bench Press",
        ...
        insertExercise(db, 28, "chest_dumbbell_fly", "Dumbbell Fly",
        ...
        insertExercise(db, 29, "chest_cable_crossover", "Cable Crossover",
        ...
        insertExercise(db, 30, "chest_machine_machine_chest_press", "Machine Chest Press",
        ...
        insertExercise(db, 31, "chest_machine_pec_deck", "Pec Deck / Machine Fly",
        ...
        insertExercise(db, 32, "chest_bodyweight_push_up", "Push-Up",
        ...
        insertExercise(db, 33, "chest_bodyweight_dips_chest_focused", "Dips (Chest-Focused)",
    ...
    private fun insertBackExercises(db: SupportSQLiteDatabase) {
        insertExercise(db, 34, "back_barbell_bent_over_row", "Barbell Bent-Over Row",
        ...
        insertExercise(db, 35, "back_bodyweight_pull_up", "Pull-Up",
        ...
        insertExercise(db, 36, "back_cable_lat_pulldown", "Lat Pulldown",
        ...
        insertExercise(db, 37, "back_cable_seated_row", "Seated Cable Row",
        ...
        insertExercise(db, 38, "back_dumbbell_single_arm_row", "Dumbbell Single-Arm Row",
        ...
        insertExercise(db, 39, "back_barbell_t_bar_row", "T-Bar Row",
        ...
        insertExercise(db, 40, "back_machine_chest_supported_row", "Chest-Supported Row",
        ...
        insertExercise(db, 41, "back_bodyweight_chin_up", "Chin-Up",
        ...
        insertExercise(db, 42, "back_cable_straight_arm_pulldown", "Straight-Arm Pulldown",
        ...
        insertExercise(db, 43, "back_cable_face_pull", "Face Pull",
        ...
        insertExercise(db, 44, "back_cable_lat_pullover", "Cable Lat Pullover",
    ...
    private fun insertShouldersExercises(db: SupportSQLiteDatabase) {
        insertExercise(db, 45, "shoulders_barbell_overhead_press", "Overhead Press (Barbell)",
        ...
        insertExercise(db, 46, "shoulders_dumbbell_shoulder_press", "Dumbbell Shoulder Press",
        ...
        insertExercise(db, 47, "shoulders_dumbbell_arnold_press", "Arnold Press",
        ...
        insertExercise(db, 48, "shoulders_dumbbell_lateral_raise", "Lateral Raise",
        ...
        insertExercise(db, 49, "shoulders_cable_lateral_raise", "Cable Lateral Raise",
        ...
        insertExercise(db, 50, "shoulders_dumbbell_front_raise", "Front Raise",
        ...
        insertExercise(db, 51, "shoulders_dumbbell_reverse_fly", "Reverse Fly (Dumbbell)",
        ...
        insertExercise(db, 52, "shoulders_barbell_upright_row", "Barbell Upright Row",
        ...
        insertExercise(db, 53, "shoulders_barbell_shrug", "Barbell Shrug",
        ...
        insertExercise(db, 54, "shoulders_dumbbell_shrug", "Dumbbell Shrug",
        ...
        insertExercise(db, 55, "shoulders_barbell_landmine_press", "Landmine Press",
    ...
    private fun insertArmsExercises(db: SupportSQLiteDatabase) {
        insertExercise(db, 56, "arms_barbell_close_grip_bench_press", "Close-Grip Bench Press",
        ...
        insertExercise(db, 57, "arms_barbell_curl", "Barbell Curl",
        ...
        insertExercise(db, 58, "arms_dumbbell_curl", "Dumbbell Curl",
        ...
        insertExercise(db, 59, "arms_dumbbell_hammer_curl", "Hammer Curl",
        ...
        insertExercise(db, 60, "arms_ez_bar_preacher_curl", "Preacher Curl",
        ...
        insertExercise(db, 61, "arms_dumbbell_incline_curl", "Incline Dumbbell Curl",
        ...
        insertExercise(db, 62, "arms_cable_curl", "Cable Curl",
        ...
        insertExercise(db, 63, "arms_ez_bar_skull_crusher", "Skull Crusher (Lying Tricep Extension)",
        ...
        insertExercise(db, 64, "arms_cable_tricep_pushdown", "Tricep Pushdown (Cable)",
        ...
        insertExercise(db, 65, "arms_dumbbell_overhead_tricep_extension", "Overhead Tricep Extension",
        ...
        insertExercise(db, 66, "arms_dumbbell_concentration_curl", "Concentration Curl",
        ...
        insertExercise(db, 67, "arms_barbell_wrist_curl", "Wrist Curl",
    ...
    private fun insertCoreExercises(db: SupportSQLiteDatabase) {
        insertExercise(db, 68, "core_bodyweight_plank", "Plank",
        ...
        insertExercise(db, 69, "core_bodyweight_ab_wheel_rollout", "Ab Wheel Rollout",
        ...
        insertExercise(db, 70, "core_bodyweight_hanging_leg_raise", "Hanging Leg Raise",
        ...
        insertExercise(db, 71, "core_cable_crunch", "Cable Crunch",
        ...
        insertExercise(db, 72, "core_bodyweight_russian_twist", "Russian Twist",
        ...
        insertExercise(db, 73, "core_bodyweight_bicycle_crunch", "Bicycle Crunch",
        ...
        insertExercise(db, 74, "core_bodyweight_dead_bug", "Dead Bug",
        ...
        insertExercise(db, 75, "core_cable_pallof_press", "Pallof Press",
        ...
        insertExercise(db, 76, "core_bodyweight_decline_sit_up", "Decline Sit-Up",
        ...
        insertExercise(db, 77, "core_bodyweight_side_plank", "Side Plank",
        ...
        insertExercise(db, 78, "core_bodyweight_dragon_flag", "Dragon Flag",
